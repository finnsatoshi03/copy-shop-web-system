export const beverages = [
  // Iced Energy
  {
    ...
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/TropicalCitrusEnergyDrink.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 2,
    ...
    category: ["Electric Elixirs"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/MelonBurstEnergyDrink.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 3,
    ...
    description:
      "A frozen iced energy drink with a tropical citrus flavor and strawberry puree.",
    calories: {
      small: 110,
      medium: 140,
      large: 180,
    ...
    category: ["Electric Elixirs"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/FrozenTropicalCitrusStrawberryEnergyDrink.jpg?impolicy=1by1_wide_topcrop_630",
  },
  ...
  // Hot Coffees: Americanos
  {
    ...
    category: ["Brewed Brilliance coffee"],
    image:
  ...
  },
  {
    ...
    description:
      "Smooth and well-balanced, with rich flavor and subtle notes of cocoa.",
    calories: {
      small: 20,
      medium: 25,
      large: 30,
  ...
  },
  {
    ...
    description:
      "The same rich and well-balanced flavor as our Pike Place® Roast, but without the caffeine.",
    calories: {
      small: 20,
      medium: 25,
      large: 30,
  ...
  },
  {
    ...
    description:
      "A mellow and soft coffee with notes of toasted nuts and chocolate.",
    calories: {
      small: 20,
      medium: 25,
      large: 30,
  ...
  },
  {
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/PikePlaceRoast.jpg?impolicy=1by1_wide_topcrop_630",
  },
  // Cappuccinos
  {
    id: 12,
    ...
    description:
      "Rich espresso with steamed milk, topped with a deep layer of foam.",
    calories: {
      small: 80,
      medium: 100,
      large: 120,
  ...
  // Espresso Shots
  {
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20190617_Espresso_Single.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 14,
    ...
    description:
      "A shot of rich espresso topped with a dollop of whipped cream.",
    calories: {
      single: 10,
      double: 15,
    },
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20190617_EspressoConPanna.jpg?impolicy=1by1_wide_topcrop_630",
  },
  ...
  // Flat Whites
  {
    ...
    description:
      "A velvety flat white made with almond milk and a hint of honey.",
    calories: {
      small: 100,
      medium: 130,
      large: 160,
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20230406_HoneyAlmondmilkFlatWhite.jpg?impolicy=1by1_wide_topcrop_630",
  },
  ...
  // Lattes
  {
    ...
    description:
      "Espresso and steamed milk with pumpkin, cinnamon, nutmeg, and clove flavors.",
    calories: {
      small: 300,
      medium: 380,
      large: 450,
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/PumpkinSpiceLatte.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 17,
  ...
  },
  {
    ...
    description:
      "Rich espresso and steamed milk topped with a light layer of foam.",
    calories: {
      small: 180,
      medium: 230,
      large: 290,
  ...
  },
  {
    ...
    description:
      "Espresso, steamed milk, and cinnamon dolce syrup topped with sweetened whipped cream.",
    calories: {
      small: 330,
      medium: 410,
      large: 490,
  ...
  // Macchiatos
  {
    ...
    description:
      "Espresso layered with steamed oatmilk, apple, and brown sugar flavors.",
    calories: {
      small: 230,
      medium: 300,
      large: 380,
    ...
    category: ["Brewed Brilliance coffee"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/AppleCrispOatmilkMacchiato.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 21,
  ...
  },
  {
    ...
    description:
      "A rich shot of espresso topped with a dollop of steamed milk foam.",
    calories: {
      single: 15,
      double: 20,
    },
  ...
  // Mochas
  {
    ...
    description:
      "Espresso, steamed milk, and rich mocha sauce topped with whipped cream.",
    calories: {
      small: 290,
      medium: 360,
      large: 440,
  ...
  },
  {
    ...
    description:
      "Espresso, steamed milk, and white chocolate-flavored sauce topped with whipped cream.",
    calories: {
      small: 350,
      medium: 430,
      large: 510,
  ...
  // Cold Coffees: Cold Brews
  {
    ...
    description:
      "Cold brew topped with pumpkin cream cold foam and a dusting of pumpkin spice.",
    calories: {
      small: 250,
      medium: 320,
      large: 390,
    ...
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/PumpkinCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 26,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20211029_SaltedCaramelCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 27,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20211217_ChocolateCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 28,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20210611_ColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 29,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20190607_VanillaSweetCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 30,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/NonDairySaltedCaramelColdBrewColdFoam.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 31,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/NonDairyVanillaSweetCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 32,
    name: "Cold Brew with Nondairy Vanilla Sweet Cream Cold Foam Sdkpaoskdpo aopskd poask podkas dkaspk poask dpos",
    price: {
      small: 4.6,
      medium: 5.1,
      large: 5.6,
    ...
    description:
      "Cold brew topped with nondairy vanilla sweet cream cold foam.",
    calories: {
      small: 130,
      medium: 170,
      large: 210,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/NonDairyVanillaSweetCreamColdFoam.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 33,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/NonDairyChocolateCreamColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  ...
  // Nitro Cold Brews
  {
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20190410_VanillaSweetCreamNitroColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
  {
    id: 35,
    ...
    category: ["Chill-Out Classics"],
    image:
      "https://globalassets.starbucks.com/digitalassets/products/bev/SBX20190410_NitroColdBrew.jpg?impolicy=1by1_wide_topcrop_630",
  },
